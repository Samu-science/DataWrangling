...
# In[1.0] Atividade nº 1

# Aplicar funções que são frequentemente utilizadas na manipulação de dados

# Se necessário, para ler dados de excel executar !pip install xlrd

# In[1.1] Importando os pacotes
...
# In[3.0]  Visualizando informações básicas do dataset
...
# In[4.0] Alterando os nomes das variáveis
...
# In[5.0] Selecionando observações e variáveis de interesse
...
# In[6.0] Criação e alteração de variáveis e seus conteúdos
...
# In[7.0] Organizando as observações do dataset por meio de critérios
...
# In[10.0] Junção de bancos de dados (merge)
...
# In[11.0] Analisando duplicidades de observações
...
# In[12.0] Excluindo valores faltantes (NA)
...
# In[13.0] Alterando a estrutura do banco de dados
