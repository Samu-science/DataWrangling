# -*- coding: utf-8 -*-
"""
Created on Mon Dec  2 15:50:56 2024

@author: SAMU-SCIENCE
"""

# In[1.0] Atividade nº 3 - Dataset Comissão de Valores Mobiliários (CVM)
...
# In[2.0] Importando os bancos de dados
...
# In[3.0] Registros únicos das contas

contas = dados_cvm['DS_CONTA'].unique()

# In[4.0] Filtrar as observações de interesse
...
# In[5.0] Vamos ajustar a variável de data (que está como texto)
...
# In[5.0] Organizar as observações
...
# In[6.0] Análise de duplicidades de observações
...
# In[8.0] Vamos adicionar os setores das empresas para fazer análises específicas
...
# In[9.0] Limpeza: vamos selecionar apenas as variáveis de interesse
...
# In[10.0] Para facilitar a leitura das informações, vamos substituir os labels
...
# In[11.0] Vamos calcular a variação percentual (variável de interesse no estudo)
...
# In[12.0] Estatísticas descritivas da VARIAÇÃO
...
# In[13.0] Vamos excluir grandes variações
...
# In[14.0] Novas estatísticas descritivas

dados_sel['VARIACAO'].describe()

# In[15.0] Informações mais detalhadas por tipo de conta (receita e resultado)

dados_sel.groupby(['CD_CONTA'])['VARIACAO'].describe().T

# In[16.0] Informações mais detalhadas por setor
