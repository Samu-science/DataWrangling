...
# In[1.0] Atividade nº 2 - Dataset WDI World Bank
...
# In[3.0] Informações básicas dos dados

dados_wdi.info()

# In[4.0] Elementos únicos das variáveis

dados_wdi['Country Name'].unique()
dados_wdi['Series Name'].unique()
dados_wdi['Topic'].unique()

# In[5.0] Alterando os nomes das variáveis
...
# In[6.0] Analisando as últimas linhas do dataset
...
# In[7.0] Excluindo as linhas finais
...
# In[8.0] Selecionando os tópicos de saúde
...
# In[9.0] Colocando as séries nas colunas
...
# In[10.0] Limpeza de observações
...
# In[12.0] Adicionar a categoria "income group" ao dataset final
...
# In[13.0] Reorganizando a posição da coluna
...
# In[14.0] Por exemplo, supondo que trata-se de um estudo sobre diabetes 
